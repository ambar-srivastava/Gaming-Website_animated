    ...
    <section className="relative h-dvh w-screen overflow-x-hidden">
        ...
        <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
            <div>
                ...
                <video src={getVideoSrc(currentIndex)} autoPlay loop muted className=" absolute left-0 top-0 size-full object-cover object-center" onLoadedData={handleVideoLoad} />
            </div>
            ...
            <div className="absolute top-0 left-0 z-40 size-full">
                <div className=" mt-24 px-5 sm:px-10">
                    ...
                    <p className=" mb-5 min-w-64 font-robert-regular text-blue-100">Enter the Metagame Layer <br /> Unleash the Play Economy </p>
